    ...
    public void loadEvents() {
        List<Event> sampleEvents = List.of(
                Event.builder()
                        ...
                        .gatheringTime(LocalDateTime.of(2024, 4, 15, 10, 0))
                        .departureTime(LocalDateTime.of(2024, 4, 15, 11, 0))
                        .endTime(LocalDateTime.of(2024, 4, 15, 18, 0))
                        .build(),
                Event.builder()
                        .id(null)
                        .eventId("EV02")
                        ...
                        .gatheringTime(LocalDateTime.of(2024, 8, 20, 9, 0))
                        .departureTime(LocalDateTime.of(2024, 8, 20, 10, 0))
                        .endTime(LocalDateTime.of(2024, 8, 20, 17, 0))
                        .build(),
                Event.builder()
                        .id(null)
                        .eventId("EV03")
                        ...
                        .gatheringTime(LocalDateTime.of(2024, 9, 5, 14, 0))
                        .departureTime(LocalDateTime.of(2024, 9, 5, 15, 0))
                        .endTime(LocalDateTime.of(2024, 9, 5, 20, 0))
                        .build(),
                Event.builder()
                        .id(null)
                        .eventId("EV04")
                        ...
                        .gatheringTime(LocalDateTime.of(2024, 5, 10, 7, 0))
                        .departureTime(LocalDateTime.of(2024, 5, 10, 8, 0))
                        .endTime(LocalDateTime.of(2024, 5, 10, 12, 0))
                        .build(),
                Event.builder()
                        .id(null)
                        .eventId("EV05")
                        ...
                        .gatheringTime(LocalDateTime.of(2024, 12, 25, 18, 0))
                        .departureTime(LocalDateTime.of(2024, 12, 25, 19, 0))
                        .endTime(LocalDateTime.of(2024, 12, 25, 23, 0))
                        .build()
        );
