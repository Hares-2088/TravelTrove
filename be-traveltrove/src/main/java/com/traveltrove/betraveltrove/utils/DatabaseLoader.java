    ...
    public void loadTours() {
        List<Tour> sampleTours = List.of(
                Tour.builder()
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_75fba018-7ec2-48c4-b557-11f37141ecdf_Fantasy-Lake1.png")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_0b5bac1a-cda6-49ab-9077-731cdd6900a4_Fantasy-Lake2.png")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_091a8e77-87b7-4acf-a41c-787d46526430_Fantasy-Lake3.png")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_4989c18f-8b06-4a9a-abf4-76c9b2fb1992_City-Rain.png")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_be9b29db-e2ac-43c0-ae91-7386dfc05d60_Fantasy-Japanese-Street.png")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_20d2a032-764d-413e-9785-9b6d36cb3936_Game-GTA.png")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_6d865e53-8dd0-4c09-a55b-d3efafb32bf3_Fantasy-Snow-Valley.png")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_801a3804-e546-45d1-86ee-6be761407833_Fantasy%20-%20Mountain%20Lake.jpeg")
                        .build(),
                Tour.builder()
                        .id(null)
                        ...
                        .tourImageUrl("https://traveltrove-images.s3.us-east-2.amazonaws.com/google-oauth2-115284042119137530811_e637c6a4-1dba-4974-8de0-2f6217c33bae_Fantasy-Hongkong.png")
                        .build(),
                Tour.builder()
                        .id(null)
    ...
    public void loadTravelers() {
        List<Traveler> sampleTravelers = List.of(
                ...
                Traveler.builder()
                        ...
                        .city("Admin City")
                        .state("NY")
                        .countryId("USA")  // Using country name here
                        .seq(1)
                        .build(),
                Traveler.builder()
                        .id(null)
                ...
                Traveler.builder()
                        ...
                        .addressLine1("111 Customer Blvd")
                        .addressLine2(null)
                        .city("Customer City")
                        .state("FL")
                        .countryId("USA")
                ...
                Traveler.builder()
                        ...
                        .addressLine1("222 Customer Blvd")
                        .addressLine2(null)
                        .city("Customer City")
                        .state("FL")
                        .countryId("USA")
                ...
                Traveler.builder()
                        ...
                        .addressLine1("333 Customer Blvd")
                        .addressLine2(null)
                        .city("Customer City")
                        .state("FL")
                        .countryId("USA")
                ...
                Traveler.builder()
                        ...
                        .addressLine1("444 Customer Blvd")
                        .addressLine2(null)
                        .city("Customer City")
                        .state("FL")
                        .countryId("USA")
                ...
                Traveler.builder()
                        ...
                        .addressLine1("555 Customer Blvd")
                        .addressLine2(null)
                        .city("Customer City")
                        .state("FL")
                        .countryId("USA")
                ...
                Traveler.builder()
                        ...
                        .firstName("Debo")
                        .lastName("Huang")
                        .email("deemohuang@gmail.com")
                        .addressLine1("111 I give up")
                        .addressLine2(null)
                        .city("Customer City")
                        .state("FL")
                        .countryId("USA")
