      ...
      <div>
        ...
        <Modal show={showModal} onHide={() => setShowModal(false)}>
          <Modal.Header closeButton>
            <Modal.Title>{modalType === "create" ? "Create Airport" : modalType === "update" ? "Edit Airport" : "Delete Airport"}</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            {modalType === "delete" ? (
                ...
                <Form>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Control
                        ...
                        isInvalid={nameError}
                    />
                    <div className="invalid-feedback">Airport name is required.</div>
                  </Form.Group>
                  <Form.Group className="mb-3">
