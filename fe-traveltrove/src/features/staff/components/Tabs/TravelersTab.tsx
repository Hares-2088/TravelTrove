...
const TravelersTab: React.FC = () => {
  ...
  const [selectedTraveler, setSelectedTraveler] = useState<TravelerResponseModel | null>(null);
  ...
  const fetchTravelers = async () => {
    try {
      ...
      console.error(t("error.fetchingTravelers"), error);
    }
  };
  ...
  const handleViewTraveler = async (travelerId: string) => {
    try {
      ...
      console.error(t("error.fetchingTravelerDetails"), error);
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error(t("error.savingTraveler"), error);
    }
  };
  ...
  const handleDelete = async () => {
    try {
      ...
      console.error(t("error.deletingTraveler"), error);
    }
  };
      ...
      {viewingTraveler ? (
        <div>
          ...
          <p>
            ...
            {viewingTraveler.addressLine1}, {viewingTraveler.addressLine2}, {viewingTraveler.city}, {viewingTraveler.state}
          </p>
          <p>
            <strong>{t("email")}: </strong>
            {viewingTraveler.email}
          </p>
        </div>
      ) : (
        <>
