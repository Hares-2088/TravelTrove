        ...
        <div>
            {viewingTraveler ? (
                <div>
                    ...
                    <h3>{viewingTraveler.firstName} {viewingTraveler.lastName}</h3>
                    <p>
                        <strong>{t('address')}:</strong> {viewingTraveler.addressLine1}, {viewingTraveler.addressLine2}, {viewingTraveler.city}, {viewingTraveler.state}
                    </p>
                    <p>
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="danger" onClick={modalType === "delete" ? handleDelete : handleSave}>
