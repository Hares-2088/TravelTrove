            ...
            <tr key={pkg.packageId}>
              ...
              <td>
                ...
                <Button
                  ...
                  className="ms-2"
                  onClick={() =>
                    navigate(`/bookings?packageId=${pkg.packageId}`)
                  }
                >
                  {t('View Bookings')}
                </Button>
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        ...
        <Modal.Body>
          {modalType === 'delete' ? (
            ...
            <div>
              <p>
                <strong>{t('packageName')}:</strong> {selectedPackage?.name}
              </p>
              <p>
                <strong>{t('packageDescription')}:</strong>{' '}
                {selectedPackage?.description}
              </p>
              <p>
                <strong>{t('startDate')}:</strong> {selectedPackage?.startDate}
              </p>
              <p>
                <strong>{t('endDate')}:</strong> {selectedPackage?.endDate}
              </p>
              <p>
                <strong>{t('priceSingle')}:</strong>{' '}
                {selectedPackage?.priceSingle}
              </p>
              <p>
                <strong>{t('priceDouble')}:</strong>{' '}
                {selectedPackage?.priceDouble}
              </p>
              <p>
                <strong>{t('priceTriple')}:</strong>{' '}
                {selectedPackage?.priceTriple}
              </p>
              <p>
              ...
              <p>
                <strong>{'totalSeats'}:</strong> {selectedPackage?.totalSeats}
              </p>
              <p>
                <strong>{'packageStatus'}:</strong>{' '}
                {selectedPackage && getPackageStatus(selectedPackage)}
              </p>
            </div>
          ) : (
